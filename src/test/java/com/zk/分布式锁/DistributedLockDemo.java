...
public class DistributedLockDemo {
    ...
    public void init() throws Exception {
        ...
        connectString = "47.92.146.108:2181,47.92.146.108:2182,47.92.146.108:2183";
        // 重试策略
        ...
        class ReadWriteLockTest {
            ...
            private void write() throws Exception {
                ...
                try {
                    Thread.sleep(10);
                    testData++;
                    System.out.println("写入数据t" + testData);
                } finally {
                    writeLock.release();
                }
            }
...
//        InterProcessLock interProcessLock = new InterProcessMultiLock(client, lockPath);
